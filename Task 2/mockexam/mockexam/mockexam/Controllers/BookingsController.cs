...
{
    [Authorize(Roles = "Admin, Staff, User, Manager")]
    public class BookingsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingsId,UserId,CheckInDate,CheckOutDate,NumberOfGuests,Status,BookingCreatedAt,SpecialRequest,IsPayed,PayedAt")] Bookings bookings)
        {
